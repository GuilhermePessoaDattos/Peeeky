    ...
    <div className="rounded-2xl bg-white p-8 shadow-xl">
      ...
      >
        ...
        <input
          ...
          className="mb-4 w-full rounded-lg border border-gray-200 px-4 py-3 text-sm outline-none transition focus:border-[#6C5CE7] focus:ring-2 focus:ring-[#6C5CE7]/20"
        />
        <button
          type="submit"
          className="w-full rounded-lg bg-[#6C5CE7] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#6C5CE7]/90"
        >
          Send magic link
        </button>
      </form>
