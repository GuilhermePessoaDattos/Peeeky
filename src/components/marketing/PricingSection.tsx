...
const plans = [
  {
    ...
    features: [
      "5 documents, 3 links each",
      "Basic page analytics & heatmaps",
      "AI Chat (10/month)",
      "eSignature (One-Click NDA)",
      "Password protection",
      "Email notifications",
      "Forward detection",
    ],
  ...
  },
  {
    ...
    features: [
      "Unlimited documents & links",
      "Full analytics, CSV export",
      "AI Chat (50/month) + chat log",
      "eSignature with templates",
      "All access controls + NDA gate",
      "Watermarking & email verification",
      "3 team members",
    ],
  ...
  },
  {
    ...
    features: [
      "Everything in Pro",
      "Unlimited AI Chat & Data Rooms",
      "Data Room folders & per-viewer permissions",
      "Full audit trails",
      "Custom domain & branding",
      "eSignature with multi-signer",
      "10 team members",
    ],
